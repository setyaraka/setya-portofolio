            ...
            logo:   <svg className="h-5 w-5" viewBox="0 0 106 120" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                        <defs>
                            ...
                            <linearGradient x1="-19.8191553%" y1="-36.7931464%" x2="138.57919%" y2="157.637507%" id="linearGradient-4">
                                <stop stopColor="#29CDFF" offset="0%"></stop>
                                <stop stopColor="#0F78FF" offset="100%"></stop>
                            </linearGradient>
                        </defs>
