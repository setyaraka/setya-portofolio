const PrismaOrmLogo = () => (
    <svg className="Nav__LogoMark-sc-11gnase-3 dUeojx h-5 w-5" fill="currentColor" viewBox="0.34 -0.059977834648891726 33.11668247084116 39.96397783464889" xmlns="http://www.w3.org/2000/svg">
