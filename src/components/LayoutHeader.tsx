    ...
    return (
        <header className="sticky top-0 z-50 backdrop-blur-sm supports-[backdrop-filter]:bg-[#f9fafb] border-b border-[#ebeef1]">
          <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <button id="navBtn" className="md:hidden p-2 rounded-lg border border-border focus-ring" aria-label="Open menu">
            ...
            <ul id="navLinks" className="hidden md:flex items-center gap-6 text-sm">
              ...
              <li>
                <a href="#" className="inline-flex items-center gap-2 rounded-xl px-4 py-2 bg-red-500 text-white hover:shadow-glow transition focus-ring">
                  Download CV
                </a>
              </li>
              <li>
                <button id="themeToggle" className="rounded-xl px-3 py-2 border border-border border-[#ebeef1] focus-ring" aria-label="Toggle theme">Dark</button>
              </li>
            </ul>
          </nav>
          <div id="drawer" className="md:hidden hidden border-t border-border bg-surface">
